                ...
                <Grid.Column>
                  <div className="task-problem">
                    ...
                    <div className="pebble-div">
                      <span>
                        {task.pebbles === '' || task.pebbles === undefined
                          ? '0'
                          : `${task.pebbles}`}
                      </span>
                      <img
                ...
                <Grid.Column>
                  <Button.Group size="mini" floated="right" compact>
                    <Button
                      ...
                      color={this.state.toggler === 'solutions' ? 'teal' : 'grey'}
                    >
                      Solutions
                    </Button>
                    <Button.Or />
                    <Button
                      name="comments"
                      onClick={this.handleButton}
                      color={this.state.toggler === 'comments' ? 'teal' : 'grey'}
                    >
                      Comments
                    </Button>
                  </Button.Group>
                  ...
                  >
                    {task.solutions ? (
                      task.solutions.map((solution, i) => (
                        <li key={i}>
                          <a href={solution.Entry.link}>{solution.Entry.text}</a>
                        </li>
                      ))
                    ) : (
                  ...
                  <ul
                    style={{ display: `${this.state.toggler === 'comments' ? 'block' : 'none'}` }}
                  >
                    {task.comments ? (
