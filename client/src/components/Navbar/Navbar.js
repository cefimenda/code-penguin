        ...
        if (this.props.landing === "true") {
            ...
            return (
                <React.Fragment>
                    ...
                    <li key="3" className="float-right"><a href="/marketplace"><p className="ui white">Marketplace</p></a></li>
                    <li key="2" className="float-right"><a href="/profile"><p className="ui white">Profile</p></a></li>
                </React.Fragment>
            )
        }
    }
